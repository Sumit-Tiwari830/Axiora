...
const StudentFee = () => {
    ...
    useEffect(() => {
        const fetchFees = async () => {
            try {
                ...
                const res = await axios.get(`${import.meta.env.VITE_BASE_URL}/FeesList/${schoolId}`);
    ...
    const handlePayment = async (fee) => {
        ...
        try {
            const orderRes = await axios.post(`${import.meta.env.VITE_BASE_URL}/razorpay/order`, {
            ...
            const options = {
                ...
                handler: async function (response) {
                    ...
                    const verifyRes = await axios.post(`${import.meta.env.VITE_BASE_URL}/razorpay/verify`, data);
