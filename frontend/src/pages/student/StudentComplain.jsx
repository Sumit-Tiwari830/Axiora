...
const StudentComplain = () => {
    ...
    const { complainsList, loading: complainsLoading } = useSelector((state) => state.complain);
    ...
    // Load student's complaint history
    useEffect(() => {
        if (school) {
    ...
    // Filter complains to show only current student's complaints and search filter
    ...
    return (
        <Box sx={{ p: { xs: 2, md: 4 } }}>
            ...
            <Typography color="text.secondary" sx={{ mb: 4 }}>
                Raise a concern or issue directly to the school administration and track its progress.
            </Typography>
                ...
                <Grid item xs={12} lg={5}>
                    ...
                    >
                        <Box sx={{ display: "flex", alignItems: "center", gap: 2, mb: 3 }}>
                            <Avatar sx={{ background: "linear-gradient(135deg, #3b82f6, #1d4ed8)", width: 44, height: 44 }}>
                                <SubmitIcon />
                            </Avatar>
                            <Box>
                                ...
                                <Typography variant="caption" color="text.secondary">
                                    Describe your concern for review
                                </Typography>
                            </Box>
                        </Box>
                            ...
                            <Stack spacing={3}>
                                ...
                                <Box>
                                    ...
                                    <TextField
                                        ...
                                        multiline
                                        rows={6}
                                        placeholder="Describe the issue clearly. Provide dates, classes or other specific details that can help resolve the problem..."
                                        value={complaint}
                    ...
                    >
                        <Box sx={{ display: "flex", gap: 2, mb: 3, flexWrap: "wrap", alignItems: "center", justifyContent: "space-between" }}>
                            <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
                                <Avatar sx={{ background: "rgba(59, 130, 246, 0.1)", color: "#3b82f6", width: 44, height: 44 }}>
                                    <HistoryIcon />
                                </Avatar>
                                <Box>
                                    <Typography variant="h6" fontWeight={700}>
                        ...
                        {complainsLoading ? (
                            ...
                            <Box sx={{ py: 10, textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center" }}>
                                ...
                                <Typography variant="caption" color="text.secondary" sx={{ maxWidth: 280, mt: 0.5 }}>
                                    If you have submitted tickets before, make sure they match your search query, or submit a new one on the left.
                                </Typography>
                            </Box>
                        ) : (
                                        ...
                                        return (
                                            <Card
                                                ...
                                                sx={{
                                                    borderRadius: "16px",
                                                    border: "1px solid rgba(226, 232, 240, 0.8)",
                                                    "&:hover": { borderColor: "#3b82f6", boxShadow: "0 4px 15px rgba(59, 130, 246, 0.05)" },
                                                    transition: "all 0.2s"
                                                }}
                                            >
                                                <CardContent sx={{ p: 3 }}>
